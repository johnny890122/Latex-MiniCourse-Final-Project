...
class Renderer():
	def __init__(self):
		...
		self.img_dct = {
						 "printer": pygame.image.load("img/printer.png").convert_alpha(),
						 "eraser_no": pygame.image.load("img/eraser_no.png").convert_alpha(),
						 "eraser_yes": pygame.image.load("img/eraser_yes.png").convert_alpha(),
						 "bar": pygame.image.load("img/bar.png").convert_alpha(),
						 "node_style": pygame.image.load("img/node_style.png").convert_alpha(),
						 "edge_style": pygame.image.load("img/edge_style.png").convert_alpha(),
		}
		self.resize_img()
	...
	def draw_sidebar(self, sidebar, mode):
		...
		if mode == "node":
			...
			pygame.gfxdraw.aacircle(self.screen, 83, 480, 28, const.color["white"])
